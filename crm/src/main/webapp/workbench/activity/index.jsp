...
<script type="text/javascript">
		...
		*/
		...
		$("#saveBtn").click(function() {
			...
			$.ajax({
				...
				url: "workbench/activity/saveBtn.do",
				data: {
	...
	/*
		...
		pageList方法：就是发出ajax请求召后台，从后台取得最新的市场活动信息列表数据
							...
							<div class="col-sm-10" style="width: 81%;">
								<!--
									...
									关于文本域textarea：
										...
										（2）textarea 虽然是以标签对的形式来呈现的，但是它页是属于表单元素范畴
