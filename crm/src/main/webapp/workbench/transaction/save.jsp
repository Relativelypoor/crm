	...
	<script>
		...
		/*
			...
			关于阶段和可能性
				...
				如果同时曼珠以上两种结论，那么我们将这样的数据保存到数据库表中就没有意义了
				如果遇到这种情况，我们需要用到properties属性配置文件来进行保存
		...
		$(function(){
			...
			$("#create-transactionStage").change(function(){
				...
				//取得选中的阶段
				var stage = $("#create-transactionStage").val();//也可以用this.val()
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" id="tranForm" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name = "activityId" value="00adb878d2d941898d934cef6633ea9a"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="马云1">
				<input type="hidden" name="contactsId" value="4919835122a04a9598a02c0201cbf883"/>
			</div>
		</div>
